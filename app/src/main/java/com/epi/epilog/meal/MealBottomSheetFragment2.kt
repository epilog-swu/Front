...
import com.epi.epilog.databinding.FragmentMealSelectBottom2Binding
...
class MealBottomSheetFragment2 : BottomSheetDialogFragment() {

    override fun getTheme(): Int {
        return R.style.RoundedBottomSheetDialog
    }

    private var _binding: FragmentMealSelectBottom2Binding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentMealSelectBottom2Binding.inflate(inflater, container, false)
        return binding.root
    }
